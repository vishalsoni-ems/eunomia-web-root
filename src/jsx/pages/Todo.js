...
import Editable from '../pages/Editable.js';
import Searchfilter from './Searchfilter';
import Button from 'react-bootstrap/Button';
import './try.css';
import Filtericonmodel from './Filtericonmodel';
...
const Todo = () =>{
	...
	return(
		<>
			<PageTitle activeMenu="Care Providers" motherMenu="Post" />
			<div className="col-12">
				...
				<div className="card">
								...
								<form onSubmit={handleEditFormSubmit}>
									<table id="example" className="display w-100 dataTable">
										<thead>
											<tr>
												<th></th>
												<th>Name <Filtericonmodel/></th>
												<th>Department <Filtericonmodel/></th>
												<th>Gender <Filtericonmodel/></th>
												<th>Education <Filtericonmodel/></th>
												<th>Mobile <Filtericonmodel/></th>
												<th>Email <Filtericonmodel/></th>
												<th>Action</th>
											</tr>
										</thead>
										<tbody>
					...
					<div className='add'>
					<Button variant="info" className='mr-3'><Link to="/form-wizard"><span style={{color:"white"}}>Add Care Provider</span></Link></Button>
					</div>
				</div>
			</div>
		</>
